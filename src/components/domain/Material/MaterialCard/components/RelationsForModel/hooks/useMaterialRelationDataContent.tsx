...
import { SearchableCharacterList, SearchableDomainList, SearchableMobList, SearchableWeaponList } from "@/components/common/SearchableList";
...
export function useMaterialRelationDataContent<TModelKey extends ModelKeys>(model: TModelKey, materialName: string) {
  ...
  return useMemo(() => {
    ...
    switch (model) {
      ...
      case 'Mob': return <SearchableMobList items={data as any} cardProps={{ wrapInLink: true, nameTag: 'h3', showRegion: true }} />;
      case 'Domain': return <SearchableDomainList items={data as any} cardProps={{ wrapInLink: true, nameTag: 'h3' }} />;
      case 'Weapon': return <SearchableWeaponList items={data as any} cardProps={{ wrapInLink: true, nameTag: 'h3', showStats: true }} />;
