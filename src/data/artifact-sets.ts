...
export const ArtifactSets = [
  ...
  new ArtifactSet("Prayers for Destiny", "Affected by Hydro for 40% less time.", ""),
  new ArtifactSet("Prayers for Illumination", "Affected by Pyro for 40% less time.", ""),
  new ArtifactSet("Prayers for Wisdom", "Affected by Electro for 40% less time.", ""),
  new ArtifactSet("Prayers to Springtime", "Affected by Cryo for 40% less time.", ""),
  new ArtifactSet(
