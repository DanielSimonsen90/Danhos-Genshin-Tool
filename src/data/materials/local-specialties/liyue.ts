...
export const GlazeLily = new LocalSpecialty(
  'Glaze Lily',
...
export const JueyunChili = new LocalSpecialty(
  'Jueyun Chili',
  `A spicy plant native to Liyue. Merely smelling it makes one hot and thirsty.`,
  'Liyue',
);

export const NoctilucousJade = new LocalSpecialty(
  'Noctilucous Jade',
...
export const Qingxin = new LocalSpecialty(
  'Qingxin',
