...
export const BrilliantChrysanthemum = new LocalSpecialty(
...
export const QuenepaBerry = new LocalSpecialty(
  'Quenepa Berry',
...
export const SaurianClawSucculent = new LocalSpecialty(
...
export const WitheringPurpurbloom = new LocalSpecialty(
