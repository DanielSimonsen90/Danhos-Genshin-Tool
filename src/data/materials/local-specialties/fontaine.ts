...
export const BerylConch = new LocalSpecialty(
  'Beryl Conch',
...
export const LakelightLily = new LocalSpecialty(
  'Lakelight Lily',
...
export const LumidouceBell = new LocalSpecialty(
  'Lumidouce Bell',
...
export const SpringOfTheFirstDewdrop = new LocalSpecialty(
...
export const SubdetectionUnit = new LocalSpecialty(
  'Subdetection Unit',
