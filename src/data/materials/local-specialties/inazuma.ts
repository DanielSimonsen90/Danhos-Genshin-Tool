...
export const AmakumoFruit = new LocalSpecialty(
  'Amakumo Fruit',
...
export const CrystalMarrow = new LocalSpecialty(
  'Crystal Marrow',
...
export const Dendrobium = new LocalSpecialty(
  'Dendrobium',
...
export const FluorescentFungus = new LocalSpecialty(
  'Fluorescent Fungus',
  `A mushroom that glows like a night-light. Some curious power lies hidden within it.`,
  'Inazuma',
);

export const NakuWeed = new LocalSpecialty(
  'Naku Weed',
...
export const Onikabuto = new LocalSpecialty(
  'Onikabuto',
