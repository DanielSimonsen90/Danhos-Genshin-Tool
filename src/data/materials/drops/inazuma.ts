...
export const PerpetualHeart = new MobDrop(
  'Perpetual Heart',
...
export const SmolderingPearl = new MobDrop(
  'Smoldering Pearl',
...
export const MarionetteCore = new MobDrop(
  'Marionette Core',
...
export const DewOfRepudiation = new MobDrop(
  'Dew of Repudiation',
  `A strange water droplet left behind by the collapse of the Hydro Hypostasis.\nIt has strong rejection properties, and this forms the basis of one of the Hydro Hypostasis' attack patterns as well. They say that water contains memories and willpower, and that these things can grow when bodies of water meld together. However the waves conjured by the Hydro Hypostasis are incompatible with the currents that flow above and below ground.\nEven if it were to flow into the surpassingly pure waters of Petrichor, this drop of water will likely resist assimilation as strongly as mercury.`,
  'Inazuma',
  Rarity.Epic
);

export const DragonheirsFalseFin = new MobDrop(
  `Dragonheir's False Fin`,
  `A piece of biological tissue that you found after defeating the Bathysmal Vishaps.\nAlthough it looks like a fin of some kind, it does not actually have any function at all.\nThe people of Byakuyakoku once investigated the Bathysmal\nVishaps quite deeply. Their most distinctive feature was the ability to choose what traits it wished to pass on to its offspring. Because of their great hatred for man-made light sources, these vishaps will lose any visual acuity by the time they reach maturity.\nAt the same time, they have also evolved a certain degree of elemental polymorphism for combat purposes.`,
  'Inazuma',
  Rarity.Epic
);

export const StormBeads = new MobDrop(
  `Storm Beads`,
...
export const RiftbornRegalia = new MobDrop(
  `Riftborn Regalia`,
...
// Signora
export const MoltenMoment = new MobDrop(
  'Molten Moment',
...
export const HellfireButterfly = new MobDrop(
  'Hellfire Butterfly',
...
export const AshenHeart = new MobDrop(
  'Ashen Heart',
...
// Raiden Shogun
export const MudraOfTheMaleficGeneral = new MobDrop(
...
export const TearsOfTheCalamitousGod = new MobDrop(
...
export const TheMeaningOfAeons = new MobDrop(
